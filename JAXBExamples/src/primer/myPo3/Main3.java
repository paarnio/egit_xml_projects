 ...
 * C:\D-PA\programs\java\2016\JAXB_ri\jaxb-ri-2.2.11\jaxb-ri\samples\inline-customize
 * 
...
public class Main3 {
    ...
    public static void main( String[] args ) {
        try {
            ...
            JAXBContext jc = JAXBContext.newInstance( "primer.myPo3" );
            ...
            JAXBElement poe = 
                (JAXBElement)u.unmarshal( new FileInputStream( "src/primer/myPo3/po.xml" ) );
	    ...
	    while( iter.hasNext()) {
                ...
                //VPA:
                System.out.println("====VPA=== item.isSetQuantity() is: " + item.isSetQuantity());
                System.out.println("====VPA=== item Quantity is: " + item.getQuantity());
                ...
                item.setPrice(item.getPrice().setScale(2, BigDecimal.ROUND_DOWN)); //VPA: getPrice() returns Decimal
            }
